...
$pow=20;
        ...
        function test_Math($count = 140000) {
            ...
            $count = $count*$pow;
                ...
                $mathFunctions = array("abs", "acos", "asin", "atan", "bindec", "floor", "exp", "sin", "tan", "pi", "is_finite", "i
s_nan", "sqrt");
        ...
        function test_StringManipulation($count = 130000) {
            ...
            $count = $count*$pow;
                $time_start = microtime(true);
                $stringFunctions = array("addslashes", "chunk_split", "metaphone", "strip_tags", "md5", "sha1", "strtoupper", "strt
olower", "strrev", "strlen", "soundex", "ord");
